...
user_agents = [
    ...
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36 Edge/91.0.864.41",
...
def load_breakpoint():
    try:
        ...
        return {"countprints": 0, "counttimes": 0, "last_article": None}


# 중단 지점 불러오기
breakpoint_data = load_breakpoint()
countprints = breakpoint_data.get("countprints", 0)
counttimes = breakpoint_data.get("counttimes", 0)
last_article = breakpoint_data.get("last_article")
...
try:
        ...
        for idx in range(1, math.ceil(len_pages)):
            ...
            try:
                ...
                for article in data:
                    ...
                    last_article = atclNo
                    save_breakpoint({"countprints": countprints, "counttimes": counttimes, "last_article": last_article})
    ...
    save_breakpoint({"countprints": 0, "counttimes": 0, "last_article": None})