...
def get_vl_list(dong_code):
    ...
    down_url = 'https://m.land.naver.com/map/getRegionList?cortarNo='+gungu_code+'&mycortarNo='+dong_code
    down_url = 'https://new.land.naver.com/api/houses/'+apt_code+'?sameAddressGroup=false
