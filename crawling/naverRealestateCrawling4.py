...
try:
    res = requests.get(url ,data={"isOnlyIsale":"false"},headers=headers)
    ...
    res2 = requests.get(remaked_URL,data={"isOnlyIsale":"false"},headers=headers)
    ...
    for v in values:
        ...
        for idx in range(1, math.ceil(len_pages)):
            ...
            res3 = requests.get(remaked_URL2,data={"isOnlyIsale":"false"},headers=headers)
